        ...
        switch ($page.params.article) {
            case "photos.svelte":
                ...
                itemsToDisplay.push({
                    ...
                    heading: 'Снимки',
                    paragraph: ' ',
                    sources: ['/clin1.png', '/clin2.png', '/clin3.png', '/clin4.png', '/clin5.png', '/clin6.png', '/clin7.png', '/clin8.png', '/clin9.png', '/clin10.png', '/clin11.png', '/clin12.png', '/clin13.png', '/clin14.png', '/clin15.png', '/clin16.png', '/clin17.png', '/clin18.png', '/clin19.png', '/clin20.png', '/clin21.png']
                });
                break;
            case "forus.svelte":
                itemsToDisplay = [];
        ...
        {#each itemsToDisplay as item }
            {#if item.type === 'text'}
                <div class="textbox">
                    ...
                    {#if item.supplementPhoto !== ' '}
                        <img class="supplementImg" src={item.supplementPhoto} alt="Не важна нимка изобразяваща нещо свързано с текста">
                    {/if}
                </div>
