...
<Group />
<div class="centering">
    <HomeSection heading="Добре Дошли в Нашата Клиника" additionaltext1={additionaltexts[0]} additionaltext2={additionaltexts[1]} imageSource={"bonusimage1.png"} infobutton={'Още снимки'}/>
    <HomeSection heading="Мерки против COVID-19" additionaltext1={additionaltexts[2]} additionaltext2={'Така може да се използва Кардио Центъра дори в тези моменти'} imageSource={'covid.png'} infobutton={'Още'} />
</div>
<div class="center">
    <Reviews />
</div>
